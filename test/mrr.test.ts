...
describe('Mrr 726271', () => {
  ...
  it('x12 has settings', () => {
    ...
    assert.deepEqual(s.data, { time: [ 1140 ], type: 'manual', heating: [ 170, 'c' ] });
  })
  ...
  it('ingredients are 4', () => {
    ...
    assert.deepEqual(i.quantity.rawData, {"unitId": "u101", "amounts": [120], "postUnit": true, "textAmount": "120g", "amountPerUnit": 1})
